...
public class MinorCoursesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.minor_courses, container, false);
    ...
    public void openMinorGrades() {
        Fragment someFragment = new MinorGradesFragment();
