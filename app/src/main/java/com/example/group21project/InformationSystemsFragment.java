...
public class InformationSystemsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.information_systems_courses, container, false);
    ...
    public void openCorrectCoursesInfoSystems() {
        Fragment someFragment = new CorrectCoursesInfoSystemsFragment();
